...
public class Villa extends Facility {
    ...
    public Villa(String id, String serviceName, double usedArea, double rentPrice, int numberPeople, String rentType, String roomStandard, double poolArea, int floor) {
